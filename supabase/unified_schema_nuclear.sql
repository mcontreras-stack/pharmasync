-- Esquema Unificado para PharmaSync en Supabase (Versión Nuclear)
-- Este script limpia COMPLETAMENTE el esquema público y lo recrea.

-- 1. LIMPIEZA AGRESIVA
-- Eliminamos todas las tablas del esquema público para evitar conflictos
DO $$ 
DECLARE
    r RECORD;
BEGIN
